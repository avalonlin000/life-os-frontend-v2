...
| # | 验收点 | 通过条件 |
|---|---|---|
| LINEUP-1 | Skill 可读 | `/home/ubuntu/.agents/skills/lol-lineup-analysis/SKILL.md` 存在并标注 v8.0 |
...
| LINEUP-4 | 输出完整 | 按十步展示版本来源、版本契合、线权、核心链、反制链、24场景筛选、四阶段、画像、固定30分钟和风险验证；不得输出宽时间范围，不得在观赛信号中引入经济/装备/龙数门槛 |
