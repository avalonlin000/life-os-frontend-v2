...
| DOC-7 | 纯阵容边界统一 | PRD/04、PRD/00、PRD/01、PRD/02、SSD/00、SSD/03、BOT_GUIDE 均写明 `lol-lineup-analysis` v8.0 只看十英雄与比赛版本，不读取队伍、选手、TS、三维、当前经济、盘口或赛果 |
...
| # | 验收点 | 通过条件 |
|---|---|---|
| LINEUP-1 | Skill 可读 | `/home/ubuntu/.agents/skills/lol-lineup-analysis/SKILL.md` 存在并标注 v8.1 |
...
| LINEUP-4 | 输出完整 | 按十步展示版本来源、版本契合、线权、核心链、反制链、24场景筛选、四阶段、画像、固定32分30秒和风险验证；不得输出宽时间范围，不得在观赛信号中引入经济/装备/龙数门槛 |
